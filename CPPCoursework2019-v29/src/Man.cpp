...
Man::Man(Psyhw4Engine* pEngine, int iID,
...
*/
void Man::virtDoUpdate(int iCurrentTime)
{
...
/** Constructor */
/** Constructor */
Man1::Man1(Psyhw4Engine* pEngine, int iID,
	int iDrawType, int iSize, int iColour,
	const char* szLabel,
	int iXLabelOffset, int iYLabelOffset,
	TileManager* pTileManager)
	: Man(pEngine, iID, iDrawType, iSize, iColour, szLabel, iXLabelOffset, iYLabelOffset)
	, m_pTileManager(pTileManager)
{
}

// Allows a caller to specify where the object will move from and to and when
void Man1::setMovement(int iStartTime, int iEndTime, int iCurrentTime,
...
Handle the update action, moving the object and/or handling any game logic
*/
void Man1::virtDoUpdate(int iCurrentTime)
{
...
/** Constructor */
Man2::Man2(Psyhw4Engine* pEngine, int iID,
	int iDrawType, int iSize, int iColour,
	const char* szLabel,
	int iXLabelOffset, int iYLabelOffset)
	: Man(pEngine, iID, iDrawType, iSize, iColour, szLabel, iXLabelOffset, iYLabelOffset)
...
void Man2::setPosition(double dX, double dY)
{
	m_dX = dX;
	m_dY = dY;
}

void Man2::setSpeed(double dSX, double dSY)
{
	m_dSX = dSX;
	m_dSY = dSY;
}
...
Handle the update action, moving the object and/or handling any game logic
*/
void Man2::virtDoUpdate(int iCurrentTime)
{
